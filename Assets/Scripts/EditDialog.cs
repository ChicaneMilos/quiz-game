...
public class EditDialog : MonoBehaviour
{
    ...
    public void SetCorrectAnswer1()
    {
        ResetCorrectButtons();
        correctAnswer = 1;
        correctButton1.GetComponent<Image>().color = Color.green;
    }
    ...
    public void SetCorrectAnswer2()
    {
        ResetCorrectButtons();
        correctAnswer = 2;
        correctButton2.GetComponent<Image>().color = Color.green;
    }
    ...
    public void SetCorrectAnswer3()
    {
        ResetCorrectButtons();
        correctAnswer = 3;
        correctButton3.GetComponent<Image>().color = Color.green;
    }
    ...
    public void SetCorrectAnswer4()
    {
        ResetCorrectButtons();
        correctAnswer = 4;
        correctButton4.GetComponent<Image>().color = Color.green;
    }
